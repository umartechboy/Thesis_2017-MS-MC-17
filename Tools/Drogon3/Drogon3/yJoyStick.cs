...
namespace Drogon3
{
    public class yJoyStick:DBPanel
    {
        public yJoyStick()
        {
        ...
        private void XyJoyStick_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            if (HeldFrom != null)
            {
                ...
                var r = Math.Min(delta.Length, (Height - HandleDia) / 2);
                DY = -delta.Y / ((Height - HandleDia) / 2);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            g.FillRectangle(new LinearGradientBrush(
                ...
                Color.FromArgb(255, 150, 170, 180),
                Color.FromArgb(255, 60, 75, 90),
                0.0F),
                10, 0, Width - 20, Height);
            DrawEllipse(g, ((float)Width) / 2, (float)HandleLocation.Y, Color.FromArgb(150, 0, 0, 0), Color.FromArgb(0, 0, 0, 0), (float)this.HandleDia + HandleHeight * 3);
            DrawEllipse(g, ((float)Width) / 2, (float)HandleLocation.Y, Color.FromArgb(255, 250, 70, 70), Color.FromArgb(255, 170, 16, 16), (float)this.HandleDia + HandleHeight);
        }
